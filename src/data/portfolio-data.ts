...
export const portfolioData = {
  profile: {
    ...
    available: true,
    availabilityNote:
      "Fin d'alternance en novembre 2026 — recherche un CDI Next.js, TypeScript, Node.js, React à partir de cette date.",
  },
  ...
  projects: [
    ...
    },
    {
      ...
      images: [
        ...
        {
          src: "/images/projects/navi/admin-settings.png",
          alt: "Écran d'administration Navi listant les modules (cookies, accessibilité, panier, stories) avec leur activation",
          width: 1291,
          height: 886,
          caption: "Back-office : activation et personnalisation des modules",
        },
        {

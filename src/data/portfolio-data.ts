...
export const portfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      images: [
        {
          src: "/images/projects/navi/hub-menu.png",
          alt: "Menu du bouton flottant Navi ouvert, avec les icônes Haut, Cookies, Accessibility et Panier",
          width: 455,
          height: 155,
          caption: "Un seul bouton flottant pour accéder à tous les modules",
        },
        {
          src: "/images/projects/navi/cookie-consent.png",
          alt: "Modale de préférences cookies avec cases Strictly Necessary, Statistics et Marketing",
          width: 480,
          height: 618,
          caption: "Préférences cookies détaillées (Google Consent Mode V2)",
        },
        {
          src: "/images/projects/navi/accessibility.png",
          alt: "Panneau d'accessibilité avec réglage de la taille du texte, contraste élevé, curseur agrandi et soulignage des liens",
          width: 405,
          height: 515,
          caption: "Panneau d'accessibilité numérique",
        },
        {
          src: "/images/projects/navi/sticky-cart.png",
          alt: "Panneau panier sticky sur une fiche produit, avec sélecteur de couleur et bouton d'ajout au panier",
          width: 632,
          height: 290,
          caption: "Panier automatique ancré sur la fiche produit",
        },
        {
          src: "/images/projects/navi/stories-player.png",
          alt: "Lecteur de story vidéo plein écran façon Instagram, dans un mockup de téléphone",
          width: 400,
          height: 759,
          caption: "Bulle Stories et lecteur vidéo plein écran",
        },
        {
          src: "/images/projects/navi/admin-general.png",
          alt: "Onglet Général du back-office Navi : position du bouton flottant, langue et apparence",
          width: 863,
          height: 1139,
          caption: "Back-office : réglages généraux (position, langue, apparence)",
        },
        {
          src: "/images/projects/navi/admin-stories-bubbles.png",
          alt: "Onglet Stories du back-office Navi, sous-onglet Bulles, avec aperçu en direct de la bulle vidéo",
          width: 864,
          height: 1266,
          caption: "Back-office : personnalisation des bulles Stories",
        },
        {
          src: "/images/projects/navi/admin-stories.png",
          alt: "Onglet Stories dans la fiche produit WooCommerce, avec import de vidéos YouTube ou MP4",
          width: 1474,
          height: 852,
          caption: "Back-office : configuration des Stories par produit",
        },
      ],
    },
    {

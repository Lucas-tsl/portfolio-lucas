...
export function CommandPalette() {
  ...
  return (
    <>
      {/* Trigger button in navbar — rendered via layout slot */}
      <button
        onClick={openPalette}
        aria-label="Ouvrir la palette de commandes"
        className="hidden md:inline-flex items-center gap-2 rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-1.5 text-xs text-zinc-500 transition hover:border-zinc-300 hover:text-zinc-700 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-400 dark:hover:border-zinc-600 dark:hover:text-zinc-300"
      >
        <Search size={13} aria-hidden="true" />
        Rechercher
        <kbd className="ml-1 rounded border border-zinc-300 bg-white px-1 py-0.5 font-mono text-[10px] dark:border-zinc-600 dark:bg-zinc-800">
          ⌘K
        </kbd>
      </button>
            ...
            >
              ...
              <div className="flex items-center gap-4 border-t border-zinc-100 px-4 py-2.5 dark:border-zinc-800">
                <span className="flex items-center gap-1 text-[10px] text-zinc-400">
                  <kbd className="rounded border border-zinc-200 bg-zinc-50 px-1 py-0.5 font-mono dark:border-zinc-700 dark:bg-zinc-800">↑↓</kbd>
                  naviguer
                </span>
                <span className="flex items-center gap-1 text-[10px] text-zinc-400">
                  <kbd className="rounded border border-zinc-200 bg-zinc-50 px-1 py-0.5 font-mono dark:border-zinc-700 dark:bg-zinc-800">↵</kbd>
                ...
                <span className="flex items-center gap-1 text-[10px] text-zinc-400">
                  <kbd className="rounded border border-zinc-200 bg-zinc-50 px-1 py-0.5 font-mono dark:border-zinc-700 dark:bg-zinc-800">Échap</kbd>
                  fermer
                </span>
              </div>
            </motion.div>
